...
Create a private GitHub repo (private matters: `seen_jobs.json` will be
...
The workflow at `.github/workflows/monitor.yml` runs every hour automatically.
