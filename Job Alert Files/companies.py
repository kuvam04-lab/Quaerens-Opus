...
COMPANIES = [
    ...
    # BASF       → SAP SuccessFactors RMK at basf.jobs. To enable, click
    #              "Engineering" on the site and copy /go/Engineering/{ID}/.
    # Kraton     → iCIMS. Use email talent network for now.
